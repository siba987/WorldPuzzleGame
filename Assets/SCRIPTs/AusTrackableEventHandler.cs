...
/// </summary>
public class AusTrackableEventHandler : gameManagerScript, ITrackableEventHandler
{
        ...
        TrackableBehaviour.Status newStatus)
    {
        ...
        {
            Debug.Log("Trackable mlevelSelected " + mlevelSelected + " & select_australia : "+select_australia);
            if(mlevelSelected && select_australia){
            Debug.Log("Australia::Trackable " + mTrackableBehaviour.TrackableName + " found");
                OnTrackingFound();
            }
        }
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        Debug.Log("Trackable " + mTrackableBehaviour.TrackableName + " found");
            ...
            // added to stop timer
            if (mTrackableBehaviour.TrackableName == "australia5")
            {

                Debug.Log(">>> Stop timer");
                PauseTimer(); //startTimer = false;
                unlock_australia = true;
